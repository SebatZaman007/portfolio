...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Education Table
                    <div style="text-align: right">
                        <a class="btn btn-primary" href="{{route('education.create')}}" role="button">Add new</a>
                    </div>
                </h5>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="dataTableHover table table-striped table-bordered first">
                            <thead>
                            <tr>
                                <th>{{ __('education_year')}}</th>
                                <th>{{ __('education_degree')}}</th>
                                <th>{{ __('education_institution')}}</th>
                                <th>{{ __('action')}}</th>
                            </tr>
                            </thead>
                            <tbody>
